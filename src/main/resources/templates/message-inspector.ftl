...
<h1 class="col threecol">Topic Messages: <a href="/kafdrop/topic/${topic.name}">${topic.name}</a></h1>
...
<div id="messageFormPanel" class="bs-panel">
    <form method="GET" action="/kafdrop/topic/${topic.name}/messages" id="messageForm" class="bs-form panel-body">
